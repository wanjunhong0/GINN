...
def parse_args():
    ...
    parser.add_argument('--attention', nargs='?', default='GINN', help='The model of attention.')
    parser.add_argument('--score_func', nargs='?', default='ConvE', help='The model of scoring function.')
